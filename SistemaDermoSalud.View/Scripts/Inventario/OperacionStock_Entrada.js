...
function eliminar(id) {
    swal({
        title: "Desea Eliminar esta Entrada de Mercancia?",
...
function MostrarxTipoMovimiento() {
    var nroguia = document.getElementById("TGuia");
    var nroCompra = document.getElementById("TCompra");
    var tipoMovimiento = document.getElementById("txtTipoMovimiento").dataset.id;
    switch (tipoMovimiento) {
        case "6": nroguia.style.display = ""; nroCompra.style.display = "none"; return gbi("txtGuia"); break;
        case "9": nroCompra.style.display = ""; nroguia.style.display = "none"; return gbi("txtCompra"); break;
        default: nroguia.style.display = "none"; nroCompra.style.display = "none";
    }
}
...
function accionModal2(url, tr, id) {
    switch (txtModal.id) {
        ...
        case "txtTipoMovimiento":
            ...
            var p;
            switch (tipoMov) {
                case "9": p = "txtCompra"; gbi("txtPrecio").value = 0; gbi("txtPrecio").disabled = true;
                    gbi("art").style.display = "none"; gbi("art2").style.display = "none"; gbi("art3").style.display = "none";
                    gbi("contentArticulo").innerHTML = ""; gbi("txtCompra").value = ""; gbi("txtGuia").value = "";
                    break;
                case "6": p = "txtGuia"; gbi("txtPrecio").value = 0; gbi("txtPrecio").disabled = true; gbi("contentArticulo").innerHTML = "";
                    gbi("art").style.display = "none"; gbi("art2").style.display = "none"; gbi("art3").style.display = "none";
                    gbi("txtCompra").value = ""; gbi("txtGuia").value = ""; break;
