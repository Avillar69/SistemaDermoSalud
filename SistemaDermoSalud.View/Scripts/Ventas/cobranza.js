...
$(function () {
    var url = "cobranza/ObtenerDatosCobroDetalle?id=2";
...
function mostrarLista(rpta) {
    ...
    if (rpta != "") {
        ...
        if (Resultado == "OK") {
            ...
            let urlDocumento = "/cobranza/ListarCobrosPendientes?id=2";
            enviarServidor(urlDocumento, cargarDatosPagosPendiente);

            let urlOrigen = "/cobranza/ObtenerCuentasOrigen";
...
function cargarDatosPagosPendiente(r) {
    ...
    $("#cboDocumento").change(function () {
        ...
        if (selectedValue !== "" && selectedValue !== null) {
            var url = '/Pago/ObtenerDatosxIDPagoVentas?id=' + selectedValue;
